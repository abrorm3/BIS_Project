...
const boothsSchema = new mongoose.Schema({
  ...
  coverImage: {
    type: String,
    default:
      "https://firebasestorage.googleapis.com/v0/b/review-e9e60.appspot.com/o/logo.png?alt=media&token=76680d07-3395-43d0-beef-25e9f5ecf175",
    validate: {
...
module.exports = mongoose.model("Review", boothsSchema);